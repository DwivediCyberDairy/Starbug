...
<html lang="en">
    <head>
        <style>
		    .ktop{min-height:500px;background:blue;}
	        #kctg{float:left;min-height:500px;background:whitesmoke;}
    ...
    <body style="overflow-x:hidden;">
        <div class="container-fluid">
            ...
            <div class="ktop"class="row">
                <div id="kctg"class="col-sm-3"><h3>Product category</h3></div>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="kidsphoto/$p"targat=_blank><img src="kidsphoto/<?php echo $x["photo"];?>"alt=""width="270"height="360"/>
