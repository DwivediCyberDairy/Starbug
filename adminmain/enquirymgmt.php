...
<html lang="en">
    <head>
        ...
        <body>
            <h2 class="text-center"style="background:bisque;">ENQUIRY DETAIL SHEET</h2><hr style="border:1px solid bisque;">
					  <div class="row">
                <div class="col-sm-12 text-center">
                     <div class="row h5">
                        <div class="col-sm-1 text-center">EQ.ID</div>
                        ...
                        <div class="col-sm-1 text-center">SUBJECT</div>
